...
var RR = {
  ...
  Observable: {
    ...
    bind: function(observableName, transform) {
      ...
      RR._replicate(subject, RR._getObservable(observableName));

      return function(evt) {
        this[observableName] = this[observableName] || subject;
        var val = typeof transform === 'function' ? transform.call(this, evt) : evt;
        return subject.onNext(val);
      };
    }
  }
};
